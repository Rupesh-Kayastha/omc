...
if ($_POST['setperm']=='addperm') {
		...
		if($count==1)
		{
			echo $updatepermision="UPDATE  user_restrict SET pid=$pid, uid=$uid, restrict_condition=$checkid WHERE pid=$pid AND uid=$uid";
		...
		{
			$insertperm="INSERT INTO user_restrict SET pid=$pid, uid=$uid, restrict_condition=$checkid";
