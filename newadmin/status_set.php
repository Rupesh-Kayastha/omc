...
if ($_POST['setperm']=='addperm') {
		...
		if($count==1)
		{
			$updatepermision="UPDATE  user_set_permission SET pid=$pid, uid=$uid, change_status=$checkid WHERE pid=$pid AND uid=$uid";
		...
		{
			$insertperm="INSERT INTO user_set_permission SET pid=$pid, uid=$uid, change_status=$checkid";
