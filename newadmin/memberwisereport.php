  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">View Memberwise Report</li>
      </ol>
    </section>
	...
	<h3 class="box-title">View Memberwise Report</h3>
	...
	<tr>
		  ...
		  <th  rowspan="2" style="width:100px;">Religion</th>
...
<table class="table table-striped table-bordered">
  ...
  <tbody>
	...
	<tr>
      ...
      <td  style="width:100px;"><a href="religionreport.php">Hinduism</a></td>
	  <td style="width:100px;">10</td>
