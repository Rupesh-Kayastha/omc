...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Report<a href="javascript:history.go(-1)" class="btn btn-primary" > Go Back</a></h1>
      <ol class="breadcrumb">
        <li><a href="home.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Religion Based Report</li>
      </ol>
    </section>
	...
	<h3 class="box-title">Religion Based Report</h3>
	 ...
	 <table class="table table-striped table-bordered">
	  <thead class="thbg">
		<tr>
		  ...
		  <th  rowspan="2" style="width:100px;">Religion Type</th>
		  <th  rowspan="2" style="width:100px;">User Name</th>
		  <th  colspan="3" style="width:100px;">No. Of Products</th>
		  <th  colspan="3" style="width:100px;">Products sold</th>
		  <th  rowspan="2" style="width:100px;">Total Revenue</th>
		</tr>
		<tr>
			<th>Audio</th>
			<th>Video</th>
...
<table class="table table-striped table-bordered">
  ...
  <tbody>
	...
	<tr>
	  <td  style="width:100px;">Hinduism</td>
      <td style="width:100px;">User Name1</th>
