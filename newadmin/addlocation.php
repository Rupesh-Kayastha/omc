...
<h3 class="box-title">Add locations for <?php echo GetName('env_monitor','env_names','id', $lid); ?></h3>
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" name="location" id="location" enctype="multipart/form-data">
              <div class="box-body">
        <div class="col-md-8" style="padding-left: 0px;">
         
          <div class="form-group">
           <input type="text" class="form-control"  value="<?php echo $resultp->location; ?>" name="location"  id="location" required=required  placeholder="Enter Location">
          </div>
          <div class="form-group">
            
            <input type="text" class="form-control" value="<?php echo $resultp->station_code; ?>" name="station_code" id="station_code" required=required placeholder="Station Code">
          </div>
          <div class="form-group">
            
            <input type="text" class="form-control" value="<?php echo $resultp->latitude; ?>" required=required name="latitude" id="contact_person" placeholder="Enter Latitude">
          </div>
          <div class="form-group">
            
            <input type="text" class="form-control" value="<?php echo $resultp->longitude; ?>" name="longitude" id="longitude" placeholder="Enter Longitude.">
          </div> 
        </div>
              </div>
              <!-- /.box-body -->
