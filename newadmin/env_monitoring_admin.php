...
$(document).ready(function () {
    ...
    $("#add-more").click(function(e){
        ...
        next = next + 1;
        var newIn = '<div id="field'+ next +'" name="field'+ next +'"><div class="col-md-12 np"><div class="col-md-2"><input class="form-control" type="date" value="" name="entrydate[]" style="line-height: 25px;"></div><div class="col-md-2"><input class="form-control" type="text" value="" name="pm10[]"></div><div class="col-md-2"><input class="form-control" type="text" value="" name="pm25[]"></div><div class="col-md-2"><input class="form-control" type="text" value="" name="so2[]"></div><div class="col-md-2"><input class="form-control" type="text" value="" name="nox[]"></div><div class="col-md-2"><input class="form-control" type="text" value="" name="co[]"></div></div></div></div>';
        var newInput = $(newIn);
