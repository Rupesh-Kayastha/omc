    ...
    $.fn.tableHeadFixer = function (param) {
        ...
        function table() {
            ...
            function fixHead() {
                ...
                setBackground(cells,settings.headBG);
                cells.css({
                    'position': 'relative'
                });
            }
            ...
            function fixFoot() {
                ...
                setBackground(cells,settings.footBG);
                cells.css({
                    'position': 'relative'
                });
            }
            ...
            function fixLeft() {
                ...
                column.each(function (k, cell) {
                    ...
                    setBackground(cell,settings.leftBG);
                    cell.css({
                        'position': 'relative'
                    });
                });
            ...
            function fixRight() {
                ...
                column.each(function (k, cell) {
                    ...
                    setBackground(cell,settings.rightBG);
                    cell.css({
                        'position': 'relative',
                        'z-index': '9999'
                    });
            ...
            function setBackground(elements,color=null) {
