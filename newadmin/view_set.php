...
if ($_POST['setperm']=='addperm') {
		...
		if($count==1)
		{
			echo $updatepermision="UPDATE  user_set_permission SET pid=$pid, uid=$uid, view=$checkid WHERE pid=$pid AND uid=$uid";
		...
		{
			echo $insertperm="INSERT INTO user_set_permission SET pid=$pid, uid=$uid, view=$checkid";
