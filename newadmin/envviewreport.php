...
if(isset($_POST['searchsubmit']))
{
    ...
    $sql1="SELECT * FROM EnvTask where AddedBy=$user and EnvManagementId=$_GET[envid] and Date Between '$fromdate' and '$todate'";
}
else
{
    $sql1="SELECT * FROM EnvTask where AddedBy=$user and EnvManagementId=$_GET[envid]";
}
...
<td style="width:80px;"><a href="addenvtask.php?editcondid=<?php echo stripslashes($result1->EnvTaskId); ?>"><i class="fa fa-edit"></i>  </a><a class="trash" href="javascript:;" id="<?php echo $result1->EnvTaskId; ?>"><i class="fa fa-trash"></i></a> </td>
   </tr>
 <?php } ?>
 </div> 
