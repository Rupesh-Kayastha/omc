...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Topic<a href="javascript:history.go(-1)" class="btn btn-primary" > Go Back</a></h1>
      <ol class="breadcrumb">
...
<div class="main-cnt"> 
	...
	<h3 class="box-title">View Topic</h3>
	<div class="thead">
...
<table class="table table-striped table-bordered">
  ...
  <tbody>
	...
	<tr>
	  ...
	  <td style="width:100px;">Toic1</td>
      <td style="width:100px;">Subject1</td>
      <td style="width:100px;">02/01/2018</td>
